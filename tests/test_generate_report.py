...
from generate_report import format_auto_fix, format_finding, generate_report, main
...
class TestFormatAutoFix:
    ...
    def test_format_auto_fix_no_pr(self):
        ...
        fix = {"package": "django", "current_version": "3.2.0", "fixed_version": "4.0.0"}
    ...
    def test_format_auto_fix_missing_versions(self):
        ...
        fix = {"package": "test-pkg", "pr_number": 789}
