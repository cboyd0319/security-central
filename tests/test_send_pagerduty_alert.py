...
from send_pagerduty_alert import main, send_alert
...
class TestMain:
    ...
    @patch("send_pagerduty_alert.send_alert")
    @patch(
        "sys.argv", ["send_pagerduty_alert.py", "--severity", "warning", "--message", "Test alert"]
    )
    ...
    @patch("send_pagerduty_alert.send_alert")
    @patch(
        "sys.argv", ["send_pagerduty_alert.py", "--severity", "critical", "--count", "not-a-number"]
    )
